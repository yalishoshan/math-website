...
"[project]/components/PageTracker.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PageTracker() {
    ...
    const startRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(Date.now());
    const activeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(true); // is the tab active?
    const activeStartRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(Date.now()); // when did current active period start
    const accumulatedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0); // accumulated active seconds before current period
    function sendTime(page) {
        // Add current active period to accumulated total
        const activeDuration = activeRef.current ? Math.round((Date.now() - activeStartRef.current) / 1000) : 0;
        ...
        function handleVisibility() {
            if (document.hidden) {
                ...
                if (activeRef.current) {
                    accumulatedRef.current += Math.round((Date.now() - activeStartRef.current) / 1000);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__755c36b6._.js.map