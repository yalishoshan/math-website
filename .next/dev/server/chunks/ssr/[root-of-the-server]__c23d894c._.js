...
const metadata = {
    ...
    description: "נוסחאות ומשפטים תקניים לגיאומטריה בשאלון 581 – שטחים, זוויות, ישרים מקבילים, משולשים דומים."
};
...
function GeometryPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$TopicPageLayout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
        ...
        description: "כל הנוסחאות והמשפטים לגיאומטריה בשאלון 581 – שטחים, זוויות, ישרים מקבילים, משולשים דומים וגובה על היתר. משפטים המסומנים (*) ניתנים לציטוט בשמם בלבד.",
        breadcrumbLabel: "גיאומטריה",
        statsChips: [
            "6 נוסחאות",
            "טבלת שטחים",
        ...
        formulasSectionSubtitle: "הנוסחאות החיוניות לכל שאלות הגיאומטריה",
        formulas: [
            {
                title: "משפט פיתגורס *",
                latex: "a^2 + b^2 = c^2",
            ...
            {
                title: "שטח משולש עם סינוס",
                latex: "S = \\tfrac{1}{2}\\,a\\,b\\,\\sin C",
                explanation: "שימושי כאשר ידועות שתי צלעות והזווית הכלואה ביניהן"
            },
            {
                title: "גובה על היתר – ממוצע הנדסי",
                latex: "h^2 = p \\cdot q",
                explanation: "הגובה אל היתר הוא הממוצע ההנדסי של שני ההיטלים. גם: a² = c·p ו-b² = c·q"
            },
            {
                title: "יחסי דמיון – שטחים",
                latex: "\\frac{S_1}{S_2} = k^2",
                explanation: "אם יחס הדמיון הוא k, יחס השטחים הוא k²"
            },
            {
                title: "שטח וקשת של מעגל",
                latex: "S_{sector} = \\frac{\\alpha}{360}\\pi r^2 \\qquad l = \\frac{\\alpha}{360}\\cdot 2\\pi r",
                explanation: "α = זווית מרכזית בדרגות; r = רדיוס"
            },
            {
                title: "קו אמצעי במשולש *",
                latex: "MN = \\tfrac{1}{2}\\,BC",
                explanation: "קו המחבר אמצעי שני צלעות מקביל לצלע השלישית ושווה למחציתה"
            }
        ],
        /* ── Section 2: טבלת שטחים ── */ mainTableSectionTitle: "נוסחאות שטח – סיכום",
        mainTableSectionSubtitle: "כל הצורות במקום אחד",
        mainTableHeaders: [
            "צורה",
            "נוסחת שטח",
            "הערה"
        ...
        /* ── Section 3: זוויות + ישרים מקבילים ── */ sideTablesSectionTitle: "זוויות וישרים מקבילים",
        sideTablesSectionSubtitle: "משפטים תקניים — המסומנים (*) ניתנים לציטוט בשמם",
        leftTableTitle: "משפטי זוויות",
        leftTableHeaders: [
            "משפט",
            "תוכן",
            "*"
        ...
        leftTableRows: [
            ...
            },
            {
                cells: [
                    "זווית חיצונית",
                    "שווה לסכום שתי הזוויות הלא-סמוכות",
                    "*"
                ]
            },
            {
                cells: [
                    "זווית במחצית עיגול",
                    "זווית ישרה (90°) — משפט תאלס",
                    "*"
                ]
            }
        ],
        rightTableTitle: "ישרים מקבילים (חותך)",
        rightTableHeaders: [
            "זוג זוויות",
            "קשר",
            "*"
        ...
        highlightTitle: "גובה על היתר — שלושת היחסים",
        highlightBody: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "text-slate-400 text-xs font-sans mr-3",
                    children: "— h גובה, p ו-q היטלים, a ו-b ניצבים, c יתר"
                }, void 0, false, {
                    fileName: "[project]/app/topic/geometry/page.tsx",
                    lineNumber: 106,
                    columnNumber: 11
        ...
        stepsSectionSubtitle: "עקבו אחרי הסדר הזה בכל שאלת גיאומטריה",
        steps: [
            {
                title: "ציירו תרשים",
                body: "סמנו את כל הנתונים על התרשים — מידות, זוויות, סימוני שוויון"
            },
            {
                title: "זהו את הצורה",
                body: "משולש דומה? מקבילית? עיגול? זהו את הצורה הרלוונטית לפני הכל"
            },
            {
                title: "בחרו משפט/נוסחה",
                body: "פיתגורס, דמיון, שטח עם sin, זוויות מקבילים — לפי הנתונים"
            },
            {
                title: "הציבו נתונים",
                body: "הכניסו את הערכים הידועים לנוסחה. שימו לב ליחידות (ס\"מ / מ')"
            },
            {
                title: "פתרו וחשבו",
                body: "בידדו את הנעלם. בדמיון — הקימו פרופורציה ופתרו"
            },
            {
                title: "בדקו סבירות",
                body: "האם השטח / האורך הגיוניים? בדקו שהיתר הוא הצלע הארוכה ביותר"
            }
        ],
        /* ── Section 5: טיפים ── */ tips: [
            "בכל שאלה — ציירו תרשים ורשמו על כל הגדלים הידועים לפני שמתחילים",
            "משולשים דומים: בדקו שלושה תנאים — ז.ז.ז, צ.ז.צ, צ.צ.צ",
            "זווית מרכזית = פי שתיים מזווית היקפית על אותה קשת (משפט הזווית המרכזית *)",
            "גובה על היתר: h² = p·q — זכרו גם את a² = c·p ו-b² = c·q",
            "חישוב שטח עם sin C שימושי כאשר לא ידוע הגובה ישירות"
        ],
        prevTopic: prev,
        nextTopic: next
    }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c23d894c._.js.map