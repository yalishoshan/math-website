...
async function POST(req) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(`signup:${ip}`, 5, 60 * 60 * 1000)) {
    ...
    if (typeof name !== "string" || typeof email !== "string" || typeof password !== "string") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (!trimmedName || trimmedName.length > 100) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "שם לא תקין"
    }, {
        status: 400
    });
    if (!EMAIL_REGEX.test(trimmedEmail) || trimmedEmail.length > 254) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "כתובת מייל לא תקינה"
    }, {
        status: 400
    });
    if (password.length < 6 || password.length > 128) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "הסיסמה חייבת להכיל בין 6 ל-128 תווים"
    }, {
        status: 400
    });
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findUnique({
        where: {
            email: trimmedEmail
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b003139._.js.map